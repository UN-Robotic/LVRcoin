...
In order to support loading of multiple wallets in LVRcoin-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to LVRcoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into LVRcoin-qt, and as such, will require some minor modifications to provide hooks for
