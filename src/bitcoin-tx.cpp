...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("LVRcoin Core LVRcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  LVRcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded LVRcoin transaction") + "\n" +
              "  LVRcoin-tx [options] -create [commands]   " + _("Create hex-encoded LVRcoin transaction") + "\n" +
              "\n";
