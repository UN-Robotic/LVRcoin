        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // LVRcoin: Disable free transactions
...
{
    // LVRcoin: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // LVRcoin: Add an increased fee for each dust output
        nFeeNeeded += GetLVRcoinDustFee(tx.vout, minTxFee);
    }
