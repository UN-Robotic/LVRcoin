...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MBTC: return QString("MLVR");
    case kBTC: return QString("kLVR");
    case BTC: return QString("LVR");
    case mBTC: return QString("mLVR");
    case uBTC: return QChar(0x03BC) + QString("LVR");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-LVRcoins (1,000,000)");
    case kBTC: return tr("Kilo-LVRcoins (1,000)");
    case BTC: return tr("LVRcoins");
    case mBTC: return tr("Milli-LVRcoins (1 / 1,000)");
    case uBTC: return tr("Micro-LVRcoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
