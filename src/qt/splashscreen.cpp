    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpaceLVR = 40;
    ...
    QString titleText       = tr("LVRcoin Core");
    ...
    QString copyrightTextLVR  = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The LVRcoin Core developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpaceLVR,copyrightTextLVR);
