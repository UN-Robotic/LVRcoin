    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("LVRcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About LVRcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  lvrcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("LVRcoin Core is shutting down...") + "<br /><br />" +
