...
// Copyright (c) 2014-2015 The LVRcoin Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("LVRcoin Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // LVRcoin: load fallback font in case Comic Sans is not availble on the system
    ...
    // LVRcoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // LVRcoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LVRcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and LVRcoin: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About LVRcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about LVRcoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for LVRcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LVRcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LVRcoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the LVRcoin Core help message to get a list with possible LVRcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("LVRcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LVRcoin network", "", count));
}
...
{
    QString strTitle = tr("LVRcoin"); // default title
