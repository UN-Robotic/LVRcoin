...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("lvrcoin.com", "seed.lvrcoin.com"));
        vSeeds.push_back(CDNSSeedData("multilvr.org", "seed.multilvr.org"));
        vSeeds.push_back(CDNSSeedData("multilvr.org", "seed2.multilvr.org"));
        vSeeds.push_back(CDNSSeedData("doger.lvrcoin.com", "seed.doger.lvrcoin.com"));
        ...
        //TODO: fix this for LVRcoin -- plddr
...
//          1435666139, // * UNIX timestamp of last checkpoint block
            1512432000, // * UNIX timestamp for 05.11.2017+1months - checkpoint block
...
//            1440601451, // * UNIX timestamp of last checkpoint block
            1517788800, // * UNIX timestamp for 05.11.2017 +3 months- checkpoint block

//            1119061,    // * total number of transactions between genesis and last checkpoint
            1023,    // * total number of transactions between genesis and last checkpoint
